...
[alice, bob, charlie, diana] = inserted_users
...
IO.puts("Seeded #{length(inserted_users)} users, 2 conversations, #{length(messages_direct) + length(messages_group)} messages")
